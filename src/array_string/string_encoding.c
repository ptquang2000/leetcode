...
// Declaration:
char* array_string_stringEncoding(const char* s);

void test_array_string_stringEncoding()
{
        {
                const char* actual = array_string_stringEncoding("aaaabcccaa");
        ...
        {
                const char* actual = array_string_stringEncoding("eeeffffee");

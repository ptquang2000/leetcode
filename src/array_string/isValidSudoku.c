...
{
        {
                ...
                UTILS_ASSERT_FALSE(array_string_isValidSudoku(partialSudoku, 9));
        }
        {
                ...
                UTILS_ASSERT_TRUE(array_string_isValidSudoku(completedSudoku, 9));
        }
        {
                int* completedSudoku[9] = {
                        (int[]){5, 3, 4, 6, 7, 8, 9, 1, 2}, (int[]){6, 7, 2, 1, 9, 5, 3, 4, 8},
                ...
                UTILS_ASSERT_FALSE(array_string_isValidSudoku(completedSudoku, 9));
        }
}

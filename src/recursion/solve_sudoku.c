...
{
        int_darray partial_assigment = {(int *[]){
                                        ...
                                        (int[]){9, 9, 9, 9, 9, 9, 9, 9, 9, 9}, 9};
        int_darray completed = {(int *[]){
                                ...
                                (int[]){9, 9, 9, 9, 9, 9, 9, 9, 9, 9}, 9};
        ASSERT_TRUE(recursion_solve_sudoku(9, partial_assigment.data));
        ASSERT_EQUAL(partial_assigment, completed);
}

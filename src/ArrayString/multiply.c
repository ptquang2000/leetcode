...
// Declaration:
int* ArrayString_multiply(int num1Size, int num1[num1Size], int num2Size, int num2[num2Size], int* numSize);
...
void test_ArrayString_multiply()
{
        ...
        int actualSize;
        int* actual = ArrayString_multiply(9, num1, 12, num2, &actualSize);

...
void test_dsa_linear_search()
{
        ...
        UTILS_ASSERT_TRUE(dsa_linear_search(ARRAY_SIZE(foo), foo, 1336));
        UTILS_ASSERT_TRUE(dsa_linear_search(ARRAY_SIZE(foo), foo, 69420));
        UTILS_ASSERT_TRUE(dsa_linear_search(ARRAY_SIZE(foo), foo, 69421));
        UTILS_ASSERT_TRUE(dsa_linear_search(ARRAY_SIZE(foo), foo, 1));
        UTILS_ASSERT_TRUE(dsa_linear_search(ARRAY_SIZE(foo), foo, 0));
}
